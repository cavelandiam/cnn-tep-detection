...
def load_images_hucsr():
    """Función principal"""
    logger.init_logger("log_s1_preprocess_data_hucsr")
    lineSeparator = "=" * 80
    
    logger.info(f"{lineSeparator}\n🚀 PREPROCESAMIENTO HUCSR - TODAS LAS SERIES\n{lineSeparator}")
    ...
    # Procesar todas las series
    preprocessor.process_all_series(patients)
