...
# =============================================================================
# MODEL COMPONENTS - OPTIMIZADO PARA MEMORIA
# =============================================================================
...
# =============================================================================
# TRAINING - OPTIMIZADO PARA MEMORIA
# =============================================================================
...
def pretrain_model():
    ...
    logger.info(f"Estudios en train_df: {train_df['StudyInstanceUID'].to_list()[:5]}... (mostrando primeros 5)")
    logger.info(f"Estudios en val_df: {val_df['StudyInstanceUID'].to_list()[:5]}... (mostrando primeros 5)")
    
    # Verificar archivos .npy
    ...
    # DataLoader optimizado para memoria
    logger.info("Creando DataLoaders optimizados...")
    train_loader = DataLoader(
        train_dataset,
        batch_size=config.BATCH_SIZE,
        shuffle=True,
        num_workers=0,  # Desactivar workers para evitar memory leaks
        pin_memory=False,  # Desactivar para reducir uso de memoria
